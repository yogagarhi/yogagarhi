...
const activityWaterfall = getCloudinaryImage("activity-waterfall.jpg");
...
const yogaAllianceBg = getCloudinaryImage("yoga-alliance-bg.jpg");
...
const apartKecakDance = getCloudinaryImage("kecak-dance.png");
...
const workshopRishikeshnese = getCloudinaryImage("workshop-Rishikeshnese.png");
...
const sattvicBreakfast = getCloudinaryImage("sattvic-breakfast.jpg");
...
const iconHighlights = [
  ...
  { icon: MapPin, title: "Rishikesh Immersion", subtitle: "12-Day Retreat" },
];
...
const excursions = [
  ...
  },
  {
    ...
    description: "Walk through Rishikesh's iconic terraced rice paddies. Experience the harmony of nature, traditional farming, and the peaceful rhythm of rural Rishikesh.",
...
const foodPhilosophy = [
  ...
  { icon: Apple, title: "Locally Sourced", description: "Fresh ingredients from Rishikesh farms" },
  ...
  const handleSyllabusSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitToFormSubmit({
        ...
        _autoresponder: "Namaste! Your requested syllabus guide is being sent to your email. We look forward to seeing you at our Yoga Teacher Training IN RISHIKESH!"
      });
    } catch (error) {
      console.error(error);
      alert("Something went wrong. Please try again.");
            ...
            <div className="max-w-4xl mx-auto flex flex-col items-center">
              ...
              <div className="space-y-10 opacity-0 animate-fade-in mb-12" style={{ animationDelay: '1.4s', animationFillMode: 'forwards' }}>
                <p className="text-2xl md:text-4xl font-medium max-w-5xl mx-auto leading-relaxed text-white">
                  Perfect for anyone looking to start their Yoga journey in a systematic way or for wellness seekers aiming to cultivate a healthy and balanced lifestyle.
                </p>
              ...
              <div className="order-1 lg:order-2">
                ...
                <div className="space-y-6 text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    ...
                    100-Hour Yoga Teacher Training IN RISHIKESH Rishikesh and join a life-changing journey
                  ...
                  >
                    <p className="pt-6">
                      ...
                      mesmerizing beauty of Rishikesh. This holistic program prepares you to become a
              ...
              <div className="lg:w-1/3 lg:sticky lg:top-24">
                ...
                <div className="mt-6 p-4 rounded-xl bg-primary/5 border border-primary/20 relative overflow-hidden group/box">
                  ...
                  <p className="text-xs md:text-sm text-foreground font-medium leading-relaxed relative z-10">
                    <span className="text-primary font-bold">Career Impact:</span> A 100-Hour Yoga Training provides a solid foundation in yoga practice and principles, building confidence, discipline, and clarity. It prepares you to guide introductory sessions, support wellness spaces, and progress toward advanced certifications, opening pathways in the global yoga and wellness industry.
                  </p>
                ...
                {[
                  {
                    ...
                    desc: "Yoga Alliance Certification to start your career anywhere.",
                    icon: Award
                  },
                  {
...
This is not a transactional relationship — it is a lifelong connection.`}
                ...
                <form onSubmit={handleWebinarSubmit} className="space-y-4 pt-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="UTC+08:00">(UTC+08:00) Singapore, Kuala Lumpur, Rishikesh</option>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-xl mx-auto">
                Immerse yourself IN RISHIKESH's spiritual heritage through transformative experiences
              </p>
            </div>
        ...
        <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="absolute inset-0 -z-10">
            <Image
              src={apartPoolVilla}
              alt="Rishikesh yoga retreat accommodation"
              fill
              className="object-cover"
            />
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="font-heading text-xl md:text-2xl text-white/90 max-w-2xl mx-auto mb-16 leading-relaxed">
              A serene yoga retreat in the heart of Rishikesh's sacred Rishikesh region
            </p>
            ...
            <div className="max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              {/* Feature 4 - Distance to Rishikesh */}
              <div className="flex items-center gap-4 bg-white/10 backdrop-blur-sm rounded-xl px-5 py-4">
                <div className="w-12 h-12 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0">
                  <MapPin className="w-6 h-6 text-white" />
                </div>
                <p className="font-heading text-base md:text-lg text-white text-left">
                  Only 15 km from central Rishikesh
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-secondary/30 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="text-center mt-10">
              <a
                href="https://www.google.com/maps/place/Yoga+Teacher+Training+in+Rishikesh+-+Yogagarhi/@-8.4645426,115.3278308,18z/data=!4m6!3m5!1s0x2dd219e70aa3e43d:0x281930517f104591!8m2!3d-8.4649127!4d115.3258379!16s%2Fg%2F11xywjhmnz?entry=ttu&g_ep=EgoyMDI2MDExMS4wIKXMDSoASAFQAw%3D%3D"
                target="_blank"
                rel="noopener noreferrer"
        ...
        <section className="py-20 bg-secondary/30">
          <div className="container mx-auto px-4">
            ...
            <p className="text-center text-muted-foreground mb-12">
              Ds Madangan Kaja, Desa Petak, Petak Kaja, Kec. Gianyar, Kabupaten Gianyar, Rishikesh 80515, Indonesia
            </p>

            <div className="max-w-4xl mx-auto">
              <div className="aspect-video rounded-lg overflow-hidden bg-muted shadow-elevated">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.5!2d115.3!3d-8.5!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd217a4e2d26eaf%3A0x5b5a8f3b5f9b9c0a!2sYoga%20Teacher%20Training%20in%20Rishikesh%20-%20Yogagarhi!5e0!3m2!1sen!2sin!4v1704067200000!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
                  ...
                  title="Yogagarhi Location - Gianyar, Rishikesh"
                />
              </div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <p className="text-sm text-muted-foreground">
                  <span className="font-medium text-foreground">Open 24 hours</span> • Gianyar, Rishikesh
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="100 Hour Yoga Teacher Training Course IN RISHIKESH">100 Hour Yoga Teacher Training Course IN RISHIKESH</option>
                  <option value="200 Hour Yoga Teacher Training Course IN RISHIKESH">200 Hour Yoga Teacher Training Course IN RISHIKESH</option>
                  <option value="300 Hour Yoga Teacher Training Course IN RISHIKESH">300 Hour Yoga Teacher Training Course IN RISHIKESH</option>
                </select>
              </div>
