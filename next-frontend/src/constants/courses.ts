export const courseData = {
    "100-hour": {
        ...
        welcomeText: "Our 100 Hour Yoga Teacher Training in Bali is for anyone who wants to deepen their yoga practice in a peaceful, natural space. Yoga Garhi is in Gianyar, just 15 km from Ubud, so you enjoy quiet village surroundings with easy access to Bali’s main yoga and cultural center. This short YTTC is perfect if you want more than normal classes but are not ready for a full 200 hour course. You learn asanas with safe alignment, basic pranayama, simple meditation, yoga philosophy, light anatomy, and the basics of how to guide a class.",
        welcomeText2: "The course suits beginners with some practice, intermediate students, and anyone curious about teaching. By the end of your 100 hours with us, you will have a stronger, safer practice, more confidence, and practical tools to handle stress and stay balanced. This training can be a complete deepening experience on its own or the first step toward your 200 hour yoga teacher training journey with Yoga Garhi.",
        features: [
    ...
    "100-hour-rishikesh": {
        title: "100 HOUR YOGA",
        subtitle: "TEACHER TRAINING COURSE IN RISHIKESH",
        duration: "12 Days",
        location: "YogaGarhi Ashram in Rishikesh India",
        level: "Beginner",
        originalPrice: "$1436",
        price: "$1149",
        certification: "Yoga Alliance Certification",
        ...
        bonus: "Get a bonus 1 month access of live class, an ancient yoga textbook, and a non-slip yoga mat to elevate your practice.",
        welcomeTitle: "Welcome to Yogagarhi",
        welcomeText: "Become a Yoga Alliance Registered Yoga Teacher through Yogagarhi's 100-Hour Yoga Teacher Training (TTC) in Rishikesh and join a life-changing journey of yoga and self-realization. The 100-Hour Yoga Teacher Training (TTC) course is made for beginners practitioners and yoga enthusiasts who want to kickstart their yoga journey. This course covers all essential aspects of yoga, including asanas, pranayama, anatomy and teaching methodology.",
        welcomeText2: "Become a part of this transformative once in a lifetime experience in the holy city of Rishikesh. This holistic program prepares you to become a professional yoga teacher having expertise, skills, and confidence. By the end of this course, you'll be ready to teach yoga anywhere in the world while spreading wellness, peace, and love.",
        features: [
            { title: "Multi-style Yoga Teaching", description: "Learn yoga in its authentic, time-tested way. Our teachers preserve the wisdom of yogic tradition." },
            { title: "Yoga Alliance Certified", description: "Receive globally recognized certification. Begin teaching yoga with confidence worldwide." },
            { title: "Spiritual Rishikesh Surroundings", description: "Experience yoga in the birthplace of yoga. The holy Ganges and Himalayan foothills deepen your practice." },
            { title: "Outdoor Excursions", description: "Explore ashrams, temples, and Ganga Aarti. Balance learning with adventure and culture." },
            { title: "Small Batch Sizes", description: "Get personal attention and guidance. Every student's growth matters to us." },
            { title: "Supportive Community", description: "Be part of a warm and positive family. Grow together in a caring environment." },
            { title: "Ayurvedic Massage", description: "Traditional Indian therapy to relieve muscle tension. Promotes deep relaxation and holistic healing." },
            { title: "Ganga Aarti Experience", description: "Witness the magnificent spiritual ceremony on the banks of the holy river Ganga." },
            { title: "Group Practice", description: "Grow together through shared learning and energy." },
            { title: "Ayurvedic Meals", description: "Enjoy sattvic and healthy meals supporting your practice." },
            { title: "Meditation Practice", description: "Deepen inner peace and mindfulness with guided sessions." },
            { title: "Experienced Instructors", description: "Learn from certified teachers with years of expertise." },
    ...
    "200-hour-rishikesh": {
        ...
        bonus: "Get a bonus 1 month access of live class, an ancient yoga textbook, and a non-slip yoga mat to elevate your practice.",
        welcomeTitle: "Welcome to Yogagarhi",
        welcomeText: "Our most popular 200-Hour Yoga Teacher Training (TTC) in Rishikesh is designed for those seeking to become certified yoga teachers with comprehensive knowledge and practical skills. This internationally recognized Yoga Alliance certification prepares you to teach confidently anywhere in the world.",
        welcomeText2: "Immerse yourself in an intensive 24-day journey covering multi-style yoga including Hatha, Vinyasa, Ashtanga, and Iyengar. Our holistic curriculum ensures you graduate not just as a yoga teacher, but as a transformed individual ready to spread the wisdom of yoga globally.",
        features: [
            { title: "Multi-style Yoga Teaching", description: "Master Hatha, Vinyasa, Ashtanga & Iyengar styles. Our comprehensive approach covers all major yoga traditions." },
            { title: "Yoga Alliance RYT-200 Certified", description: "Receive the globally recognized 200-hour certification. Teach yoga professionally anywhere in the world." },
